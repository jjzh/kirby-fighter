...
const BUTTON_ICONS: Record<string, string[]> = {
  light: [ // Fist — detailed punch with knuckle ridges
    '...#####...',
    '..##.##.#..',
    '..#######..',
    '..##.##.#..',
  ...
  heavy: [ // Kick — leg with boot and motion lines
    '##...........',
    '.............',
    '.##..........',
    '..##.........',
  ...
  jump: [ // Boot — chunky sole with treads, jumping up
    '....##.....',
    '...####....',
    '...####....',
    '...#..#....',
  ...
  suck: [ // Swirl — thick spiral vortex
    '...#####...',
    '.##....##..',
    '.#..###.##.',
    '#..##..#..#',
