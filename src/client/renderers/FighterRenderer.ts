...
export class FighterRenderer {
  ...
  private createAnimations(scene: Phaser.Scene): void {
    const anims: { key: string; frames: string[]; frameRate: number; repeat: number }[] = [
      ...
      { key: 'kirby_inhale', frames: ['inhale_0', 'inhale_1', 'inhale_2', 'inhale_2', 'inhale_3', 'inhale_3', 'inhale_3', 'inhale_3', 'inhale_3', 'inhale_4', 'inhale_4', 'inhale_4', 'inhale_4', 'inhale_4'], frameRate: 12, repeat: -1 },
